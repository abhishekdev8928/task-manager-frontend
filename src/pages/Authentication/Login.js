...
import {
  Row, Col, Input, Button, Alert, Container, Label
} from "reactstrap";
                ...
                <Col lg={9}>
                  <div>
                    <div className="text-center">
                      <Link to="/">
                        <img src={logodark} height="35" className="auth-logo logo-dark mx-auto" alt="dark" />
                        <img src={logolight} height="35" className="auth-logo logo-light mx-auto" alt="light" />
                      </Link>
                      ...
                      {({
                        ...
                        <form className="form-horizontal" onSubmit={handleSubmit}>
                          ...
                          <div className="mt-4 text-center">
                            <Button color="primary" className="w-md" type="submit" disabled={isSubmitting}>
                              Log In
                            </Button>
                          </div>

                          {errors.submit && (
                            <div className="mt-2 text-danger text-center">{errors.submit}</div>
                          )}
                    ...
                    <div className="mt-5 text-center">
                      ...
                      <p>
                        ...
                        <a href="https://www.digihost.in/" target="_blank" rel="noreferrer">
                          DiigiiHost
                        </a>
                        .
                      </p>
